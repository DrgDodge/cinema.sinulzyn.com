...
<div class="w-full h-full flex flex-col items-center justify-center p-4 md:p-8 font-sans overflow-hidden">
    <div class="w-full max-w-sm relative animate-in fade-in zoom-in-95 duration-700 ease-out">
        <!-- Digital Pass View with Refraction -->
        ...
        <div class="flex gap-4 mt-8">
            <button 
                onclick={copyLink} 
                class="flex-1 bg-white hover:bg-gray-200 text-black font-semibold py-4 rounded-[1.5rem] transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_rgba(255,255,255,0.4)] flex items-center justify-center gap-2 text-sm hover:-translate-y-1 active:translate-y-0"
            >
            ...
            <a 
                href="/scan" 
                class="flex-1 bg-white/10 backdrop-blur-xl backdrop-saturate-150 border border-white/20 hover:bg-white/20 text-white font-medium py-4 rounded-[1.5rem] transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.2)] text-center flex items-center justify-center gap-2 text-sm hover:-translate-y-1 active:translate-y-0"
            >
                Back to Scanner
            </a>
        </div>
